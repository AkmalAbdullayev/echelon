                            ...
                            <div class="card-body">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" value="admin" class="form-control @error('password') is-invalid @enderror" id="exampleInputPassword1" placeholder="Введите ваш пароль" required>
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group d-flex flex-md-row flex-column justify-content-between align-items-center">
                                        <div class="text-left">
                                            <div class="checkbox checkbox-sm">
                                                <input type="checkbox" name="remember" class="form-check-input" id="exampleCheck1" {{ old('remember') ? 'checked' : '' }} checked>
                                                <label class="checkboxsmall" for="exampleCheck1"><small>Запомнить</small></label>
                                            </div>
                                        </div>
