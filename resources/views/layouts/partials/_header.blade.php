                    ...
                    <ul class="nav navbar-nav">
                        <li class="nav-item d-none d-lg-block">
                            ...
                            <div class="bookmark-input search-input">
                                ...
                                <input class="form-control input" type="text" placeholder="Explore Echelon..." tabindex="0" data-search="template-search">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            ...
                            <a class="dropdown-item" href="#" data-language="uz"><i class="flag-icon flag-icon-uz mr-50"></i> Uzbek</a>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                    ...
                    <li class="nav-item nav-search">
                        ...
                        <div class="search-input">
                            <div class="search-input-icon"><i class="bx bx-search primary"></i>
                            </div>
                            <input class="input" type="text" placeholder="Explore Echelon..." tabindex="-1" data-search="template-search">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                            ...
                            <li class="scrollable-container media-list">
                                ...
                                <div class="d-flex justify-content-between read-notification cursor-pointer">
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left pr-0">
                                            <div class="avatar mr-1 m-0">
                                                <img src="{{ asset('app-assets/images/portrait/small/avatar-s-16.jpg') }}" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                        ...
                        <div class="dropdown-menu dropdown-menu-right pb-0">
                            ...
                            <a class="dropdown-item confirmDelete" href="" data-form="logout">
