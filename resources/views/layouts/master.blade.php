...
<head>
    ...
    <title>{{ $title ?? 'Главная' }} | Echelon</title>
...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0">
            <span class="float-left d-inline-block">{{ now()->format('Y') }} &copy; Echelon</span>
            <span class="float-right d-sm-inline-block d-none">Created by <a class="text-uppercase" href="https://smarttechnology.uz" target="_blank">Smart technology</a></span>
